...
if __name__ == "__main__":
    ...
    if(model_selection == "vit_base" and args.seq_len == 2048):
        seq_len = 512
    ...
    STOF_tuning_time = (t_end - t_start) * 1000
    
    print("\n e2e {} | bs:{} | seq:{}  |  STOF Tuning Cost : {:.3f} ms \n".format(model_selection, batch_size, args.seq_len, STOF_tuning_time)) 
